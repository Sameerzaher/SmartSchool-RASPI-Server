...
def change_feature_state_service(device_id, state):
    """Change the state of an IoT device feature."""
    ...
    try:
        ...
        if 'application/json' in response.headers.get('Content-Type', '').lower():
            ...
            return {'success': False, 'message': "Received non-JSON response", 'status_code': response.status_code}
    except requests.HTTPError as e:
...
#         data = response.json()
#         logging.debug("API Response Data: {}".format(data))
#         return data
#     except requests.HTTPError as e:
#         logging.error("HTTP Error: {}".format(e.response.text))
#         return jsonify(success=False, message='HTTP Error occurred', details=str(e)), 500
#     except requests.RequestException as e:
#         logging.error("Request Failed: {}".format(e))
#         return jsonify(success=False, message='Error fetching IoT devices', details=str(e)), 500
#     except ValueError as e:
#         logging.error("JSON Decode Error: {}".format(e))
#         return jsonify(success=False, message='Error decoding JSON data', details=str(e)), 500
